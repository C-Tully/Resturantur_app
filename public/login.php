      ...
      <div id="first">
        <div class="myform form ">
          <div class="logo mb-3">
            ...
            <?php 
              include('components/message-bubble.inc.php');
            ?>

          </div>
          <form action="/public/index.php?page=login" method="post" name="login"> 
            <input type="hidden" name="login" value="login<?php //todo echo out csrf token  ?>" />   
            ...
            <div class="form-group">
              <p class="text-center">Don't have account? <a href="/public/register.php" id="signup">Sign up here</a></p>
            </div>
          </form>
        </div>
      </div>
